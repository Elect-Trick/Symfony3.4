...
$c = new \Doctrine\ORM\Mapping\Driver\AnnotationDriver(${($_ = isset($this->services['annotation_reader']) ? $this->services['annotation_reader'] : $this->getAnnotationReaderService()) && false ?: '_'}, [0 => ($this->targetDirs[3].'\\src\\UserBundle\\Entity'), 1 => ($this->targetDirs[3].'\\src\\OrdersBundle\\Entity'), 2 => ($this->targetDirs[3].'\\src\\OutagesBundle\\Entity'), 3 => ($this->targetDirs[3].'\\src\\ServicesBundle\\Entity')]);

$b->addDriver($c, 'UserBundle\\Entity');
$b->addDriver($c, 'OrdersBundle\\Entity');
$b->addDriver($c, 'OutagesBundle\\Entity');
$b->addDriver($c, 'ServicesBundle\\Entity');

$a->setEntityNamespaces(['UserBundle' => 'UserBundle\\Entity', 'OrdersBundle' => 'OrdersBundle\\Entity', 'OutagesBundle' => 'OutagesBundle\\Entity', 'ServicesBundle' => 'ServicesBundle\\Entity']);
