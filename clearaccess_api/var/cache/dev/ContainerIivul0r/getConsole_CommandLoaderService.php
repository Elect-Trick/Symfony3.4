...
}, 'lexik_jwt_authentication.check_config_command' => function () {
    $f = function (\Lexik\Bundle\JWTAuthenticationBundle\Command\CheckConfigCommand $v) { return $v; }; return $f(${($_ = isset($this->services['lexik_jwt_authentication.check_config_command']) ? $this->services['lexik_jwt_authentication.check_config_command'] : $this->load('getLexikJwtAuthentication_CheckConfigCommandService.php')) && false ?: '_'});
}, 'lexik_jwt_authentication.generate_token_command' => function () {
    $f = function (\Lexik\Bundle\JWTAuthenticationBundle\Command\GenerateTokenCommand $v) { return $v; }; return $f(${($_ = isset($this->services['lexik_jwt_authentication.generate_token_command']) ? $this->services['lexik_jwt_authentication.generate_token_command'] : $this->load('getLexikJwtAuthentication_GenerateTokenCommandService.php')) && false ?: '_'});
