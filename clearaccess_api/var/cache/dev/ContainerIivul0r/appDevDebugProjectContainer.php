...
class appDevDebugProjectContainer extends Container
{
    ...
    public function __construct(array $buildParameters = [], $containerDir = __DIR__)
    {
        ...
        $this->normalizedIds = [
            ...
            'jwtbundle\\controller\\defaultcontroller' => 'JwtBundle\\Controller\\DefaultController',
            'jwtbundle\\jwtauthenticator' => 'JwtBundle\\JWTAuthenticator',
            ...
            'userbundle\\controller\\defaultcontroller' => 'UserBundle\\Controller\\DefaultController',
        ];
        $this->syntheticIds = [
            'kernel' => true,
        ];
        ...
        $this->fileMap = [
            ...
            'JwtBundle\\Controller\\DefaultController' => 'getDefaultController2Service.php',
            'JwtBundle\\JWTAuthenticator' => 'getJWTAuthenticatorService.php',
            ...
            'UserBundle\\Controller\\DefaultController' => 'getDefaultController3Service.php',
            ...
            'security.authentication.listener.json.main' => 'getSecurity_Authentication_Listener_Json_MainService.php',
            ...
            'security.request_matcher.6j6lyjq' => 'getSecurity_RequestMatcher_6j6lyjqService.php',
            'security.user.provider.concrete.in_memory' => 'getSecurity_User_Provider_Concrete_InMemoryService.php',
            'security.user.provider.concrete.token_auth' => 'getSecurity_User_Provider_Concrete_TokenAuthService.php',
            ...
            'service_locator.tlbzx3j' => 'getServiceLocator_Tlbzx3jService.php',
        ...
        $this->privates = [
            ...
            'JwtBundle\\JWTAuthenticator' => true,
            ...
            'security.request_matcher.6j6lyjq' => true,
            'security.role_hierarchy' => true,
            'security.user.provider.concrete.in_memory' => true,
            'security.user.provider.concrete.token_auth' => true,
            'security.user_checker' => true,
            'security.user_value_resolver' => true,
            'security.validator.user_password' => true,
            'service_locator.tlbzx3j' => true,
    ...
    {
        $a = new \Symfony\Component\Cache\Adapter\FilesystemAdapter('I+QyxzCSx4', 0, ($this->targetDirs[0].'/pools'));
    ...
    {
        return $this->services['cache.system'] = new \Symfony\Component\Cache\Adapter\TraceableAdapter(\Symfony\Component\Cache\Adapter\AbstractAdapter::createSystemCache('dBSkvBG9ei', 0, $this->getParameter('container.build_id'), ($this->targetDirs[0].'/pools'), ${($_ = isset($this->services['monolog.logger.cache']) ? $this->services['monolog.logger.cache'] : $this->getMonolog_Logger_CacheService()) && false ?: '_'}));
    }
    ...
    {
        return $this->services['cache.annotations'] = new \Symfony\Component\Cache\Adapter\TraceableAdapter(\Symfony\Component\Cache\Adapter\AbstractAdapter::createSystemCache('yJZ-0n+xpQ', 0, $this->getParameter('container.build_id'), ($this->targetDirs[0].'/pools'), ${($_ = isset($this->services['monolog.logger.cache']) ? $this->services['monolog.logger.cache'] : $this->getMonolog_Logger_CacheService()) && false ?: '_'}));
    }
    ...
    {
        return $this->services['cache.serializer'] = new \Symfony\Component\Cache\Adapter\TraceableAdapter(\Symfony\Component\Cache\Adapter\AbstractAdapter::createSystemCache('VTXuipDO+Z', 0, $this->getParameter('container.build_id'), ($this->targetDirs[0].'/pools'), ${($_ = isset($this->services['monolog.logger.cache']) ? $this->services['monolog.logger.cache'] : $this->getMonolog_Logger_CacheService()) && false ?: '_'}));
    }
    ...
    {
        return $this->services['cache.validator'] = new \Symfony\Component\Cache\Adapter\TraceableAdapter(\Symfony\Component\Cache\Adapter\AbstractAdapter::createSystemCache('F6fkshRifB', 0, $this->getParameter('container.build_id'), ($this->targetDirs[0].'/pools'), ${($_ = isset($this->services['monolog.logger.cache']) ? $this->services['monolog.logger.cache'] : $this->getMonolog_Logger_CacheService()) && false ?: '_'}));
    }
    ...
    {
        return $this->services['security.firewall.map'] = new \Symfony\Bundle\SecurityBundle\Security\FirewallMap(new \Symfony\Component\DependencyInjection\ServiceLocator(['security.firewall.map.context.api' => function () {
            ...
            yield 'security.firewall.map.context.api' => ${($_ = isset($this->services['security.request_matcher.6j6lyjq']) ? $this->services['security.request_matcher.6j6lyjq'] : ($this->services['security.request_matcher.6j6lyjq'] = new \Symfony\Component\HttpFoundation\RequestMatcher('^/api/'))) && false ?: '_'};
    ...
    protected function getTwig_LoaderService()
    {
        ...
        $instance->addPath(($this->targetDirs[3].'\\src\\UserBundle/Resources/views'), '!User');
        $instance->addPath(($this->targetDirs[3].'\\src\\OrdersBundle/Resources/views'), 'Orders');
        $instance->addPath(($this->targetDirs[3].'\\src\\OrdersBundle/Resources/views'), '!Orders');
        $instance->addPath(($this->targetDirs[3].'\\src\\JwtBundle/Resources/views'), 'Jwt');
        $instance->addPath(($this->targetDirs[3].'\\src\\JwtBundle/Resources/views'), '!Jwt');
        $instance->addPath(($this->targetDirs[3].'\\src\\OutagesBundle/Resources/views'), 'Outages');
        $instance->addPath(($this->targetDirs[3].'\\src\\OutagesBundle/Resources/views'), '!Outages');
        $instance->addPath(($this->targetDirs[3].'\\src\\ServicesBundle/Resources/views'), 'Services');
        $instance->addPath(($this->targetDirs[3].'\\src\\ServicesBundle/Resources/views'), '!Services');
    ...
    private function getDynamicParameter($name)
    {
        switch ($name) {
            ...
            case 'kernel.bundles_metadata': $value = [
                ...
                'OrdersBundle' => [
                    'parent' => NULL,
                    'path' => ($this->targetDirs[3].'\\src\\OrdersBundle'),
                    'namespace' => 'OrdersBundle',
                ],
                'JwtBundle' => [
                    'parent' => NULL,
                    'path' => ($this->targetDirs[3].'\\src\\JwtBundle'),
                    'namespace' => 'JwtBundle',
                ],
                'OutagesBundle' => [
                    'parent' => NULL,
                    'path' => ($this->targetDirs[3].'\\src\\OutagesBundle'),
                    'namespace' => 'OutagesBundle',
                ],
                'ServicesBundle' => [
                    'parent' => NULL,
                    'path' => ($this->targetDirs[3].'\\src\\ServicesBundle'),
    ...
    protected function getDefaultParameters()
    {
        return [
            ...
            'kernel.bundles' => [
                ...
                'OrdersBundle' => 'OrdersBundle\\OrdersBundle',
                'JwtBundle' => 'JwtBundle\\JwtBundle',
                'OutagesBundle' => 'OutagesBundle\\OutagesBundle',
                'ServicesBundle' => 'ServicesBundle\\ServicesBundle',
            ...
            'lexik_jwt_authentication.pass_phrase' => 'mafdhklkjkn234kas',
            'lexik_jwt_authentication.token_ttl' => 5600,
